...
- Java后端使用技术：Spring、Spring Boot、MyBatis、MyBatis Plus、Knife4j、Hutool、Sa-Token、Lettuce、POI、PDFBox
- Python后端使用技术：FastAPI、Uvicorn、HuggingFace、PyTorch、Transformers、PyPDF2、docx2txt
